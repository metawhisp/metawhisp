...
3. **ProjectAggregator clutter** — 52 alias rows; 46 are 1-conv noise (Голосок/VoiceSnack dup, Island/Island Expand/Island Expend typos, Acme-zoo). Plan: threshold ≥ 2 conv before showing in Projects view + delete-button per row + Latin/Cyrillic transliteration dedup at alias-creation time.
