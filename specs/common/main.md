...
**Расширенная версия (эта сессия):** добавлены фичи, которые обычно делают "privacy-invasive" приложения типа Omi Desktop — запись созвонов, контекст экрана, AI-советы — но **с локальной обработкой**. Omi шлёт всё в Firebase/Pinecone/OpenAI. MetaWhisp держит у себя.
...
В отличие от Omi, MetaWhisp не хранит JPEG. Pipeline:
