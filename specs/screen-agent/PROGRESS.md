...
- [ ] **2.1-bis Потолок у пробы** — ворота без потолка морят голодом: окно, на
      которое человек смотрит час, не даёт ни строки. Референс хранит снимок,
      подавленный дольше `forceCaptureInterval`, независимо от похожести.
      **Открыто — это регресс, внесённый 2.1.**
