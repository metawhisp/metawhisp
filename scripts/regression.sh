...
CRITICAL_SUITES=(
    ...
    CalendarRetryRespectsARefusalTests
    StopReasonIsARefusalTests
    GateRespectsAManualStopTests
    ...
    ScreenContentFingerprintTests
    ScreenCaptureOutcomeTests
    ScreenOCRTests
    ScreenAgentDeliveryTests
    ScreenAgentThreadAnchorTests
